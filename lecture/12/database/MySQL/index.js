...
const { MYSQL_DB_NAME, MYSQL_PASSWORD, MYSQL_USER } = require('../../config/config');

module.exports = (() => {
    let instance;

    const initConnection = () => {
        const client = new Sequelize(MYSQL_DB_NAME, MYSQL_USER, MYSQL_PASSWORD, { dialect: 'mysql' }); // connection
